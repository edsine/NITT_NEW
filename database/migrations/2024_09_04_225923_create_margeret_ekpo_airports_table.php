...
class CreateMargeretEkpoAirportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('margeret_ekpo_airports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('margeret_ekpo_airports');
    }
}
