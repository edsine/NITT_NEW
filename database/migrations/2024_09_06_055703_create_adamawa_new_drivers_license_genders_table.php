...
class CreateAdamawaNewDriversLicenseGendersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('adamawa_new_drivers_license_genders', function (Blueprint $table) {
            $table->id();
            $table->string('year');
    ...
    {
        Schema::dropIfExists('adamawa_new_drivers_license_genders');
    }
}
