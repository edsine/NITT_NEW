...
class CreateSultanSaddikAirportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sultan_saddik_airports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sultan_saddik_airports');
    }
}
