...
class CreateMallamAminuAirportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mallam_aminu_airports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mallam_aminu_airports');
    }
}
