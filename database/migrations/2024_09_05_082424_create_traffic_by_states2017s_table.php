...
class CreateTrafficByStates2017sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('traffic_by_states2017s', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('traffic_by_states2017s');
    }
}
