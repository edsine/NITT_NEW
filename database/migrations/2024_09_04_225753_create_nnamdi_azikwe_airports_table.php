...
class CreateNnamdiAzikweAirportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nnamdi_azikwe_airports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('nnamdi_azikwe_airports');
    }
}
