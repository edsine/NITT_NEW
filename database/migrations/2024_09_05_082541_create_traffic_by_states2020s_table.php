...
class CreateTrafficByStates2020sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('traffic_by_states2020s', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('traffic_by_states2020s');
    }
}
