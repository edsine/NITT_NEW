...
class CreateMurtalaMuhammedAirportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('murtala_muhammed_airports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('murtala_muhammed_airports');
    }
}
