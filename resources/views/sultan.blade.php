...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Sultan Saddik Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('sultan.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('sultan.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($sultans as $sultan)
            <tr>
                <td>{{ $sultan->id }}</td>
                <td>{{ $sultan->year }}</td>
                <td>{{ $sultan->domestic_passenger_traffic }}</td>
                <td>{{ $sultan->international_passenger_traffic }}</td>
                <td>{{ $sultan->air_traffic_domestic }}</td>
                <td>{{ $sultan->air_traffic_international }}</td>
                <td>{{ $sultan->cargo_traffic_domestic }}</td>
                <td>{{ $sultan->cargo_traffic_international }}</td>
                <td>{{ $sultan->mail_traffic_domestic }}</td>
                <td>{{ $sultan->mail_traffic_international }}</td>
