...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Murtala Muhammed International Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('murtala.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('murtala.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($murtalas as $murtala)
            <tr>
                <td>{{ $murtala->id }}</td>
                <td>{{ $murtala->year }}</td>
                <td>{{ $murtala->domestic_passenger_traffic }}</td>
                <td>{{ $murtala->international_passenger_traffic }}</td>
                <td>{{ $murtala->air_traffic_domestic }}</td>
                <td>{{ $murtala->air_traffic_international }}</td>
                <td>{{ $murtala->cargo_traffic_domestic }}</td>
                <td>{{ $murtala->cargo_traffic_international }}</td>
                <td>{{ $murtala->mail_traffic_domestic }}</td>
                <td>{{ $murtala->mail_traffic_international }}</td>
