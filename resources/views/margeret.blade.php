...
@endif
    ...
    <div class="d-flex">
        ...
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('margeret.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('margeret.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($margerets as $mag)
            <tr>
                <td>{{ $mag->id }}</td>
                <td>{{ $mag->year }}</td>
                <td>{{ $mag->domestic_passenger_traffic }}</td>
                <td>{{ $mag->international_passenger_traffic }}</td>
                <td>{{ $mag->air_traffic_domestic }}</td>
                <td>{{ $mag->air_traffic_international }}</td>
                <td>{{ $mag->cargo_traffic_domestic }}</td>
                <td>{{ $mag->cargo_traffic_international }}</td>
                <td>{{ $mag->mail_traffic_domestic }}</td>
                <td>{{ $mag->mail_traffic_international }}</td>
