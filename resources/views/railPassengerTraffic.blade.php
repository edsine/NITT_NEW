...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Rail Passenger Trafic And Revenue Accrued From 1964-2022</h5>

            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('RailPassengerTraffic.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('RailPassengerTraffic.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($RailPassengerTraffics as $RailPassengerTraffic)
            <tr>
                <td>{{ $RailPassengerTraffic->id }}</td>
                <td>{{ $RailPassengerTraffic->year }}</td>
                <td>{{ $RailPassengerTraffic->passenger_volume }}</td>
                <td>{{ $RailPassengerTraffic->revenue }}</td>
                <td>{{ $RailPassengerTraffic->freight }}</td>
