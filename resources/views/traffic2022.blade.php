...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Year 2022 Road Traffic Crashes (RTC) Records by States in Nigeria
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('traffic2022.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('traffic2022.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($traffic2022s as $traffic)
            <tr>
                <td>{{ $traffic->id }}</td>
                <td>{{ $traffic->state }}</td>
                <td>{{ $traffic->fatal_cases }}</td>
                <td>{{ $traffic->serious_cases }}</td>
                <td>{{ $traffic->minor_cases }}</td>
                <td>{{ $traffic->total_cases }}</td>
                <td>{{ $traffic->persons_killed}}</td>
                <td>{{ $traffic->persons_injured }}</td>
                <td>{{ $traffic->total_casualty }}</td>
