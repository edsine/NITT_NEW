...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Yola Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('yola.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('yola.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($yolas as $yola)
            <tr>
                <td>{{ $yola->id }}</td>
                <td>{{ $yola->year }}</td>
                <td>{{ $yola->domestic_passenger_traffic }}</td>
                <td>{{ $yola->international_passenger_traffic }}</td>
                <td>{{ $yola->air_traffic_domestic }}</td>
                <td>{{ $yola->air_traffic_international }}</td>
                <td>{{ $yola->cargo_traffic_domestic }}</td>
                <td>{{ $yola->cargo_traffic_international }}</td>
                <td>{{ $yola->mail_traffic_domestic }}</td>
                <td>{{ $yola->mail_traffic_international }}</td>
