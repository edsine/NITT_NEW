...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Kaduna Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('kaduna.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('kaduna.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($kadunas as $kaduna)
            <tr>
                <td>{{ $kaduna->id }}</td>
                <td>{{ $kaduna->year }}</td>
                <td>{{ $kaduna->domestic_passenger_traffic }}</td>
                <td>{{ $kaduna->international_passenger_traffic }}</td>
                <td>{{ $kaduna->air_traffic_domestic }}</td>
                <td>{{ $kaduna->air_traffic_international }}</td>
                <td>{{ $kaduna->cargo_traffic_domestic }}</td>
                <td>{{ $kaduna->cargo_traffic_international }}</td>
                <td>{{ $kaduna->mail_traffic_domestic }}</td>
                <td>{{ $kaduna->mail_traffic_international }}</td>
