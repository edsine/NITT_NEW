...
@endif
    ...
    <div class="d-flex">
        ...
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('samMbakwe.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('samMbakwe.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($samMbakwes as $sam)
            <tr>
                <td>{{ $sam->id }}</td>
                <td>{{ $sam->year }}</td>
                <td>{{ $sam->domestic_passenger_traffic }}</td>
                <td>{{ $sam->international_passenger_traffic }}</td>
                <td>{{ $sam->air_traffic_domestic }}</td>
                <td>{{ $sam->air_traffic_international }}</td>
                <td>{{ $sam->cargo_traffic_domestic }}</td>
                <td>{{ $sam->cargo_traffic_international }}</td>
                <td>{{ $sam->mail_traffic_domestic }}</td>
                <td>{{ $sam->mail_traffic_international }}</td>
