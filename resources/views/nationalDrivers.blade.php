...
@section('title', 'national Drivers')
...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>National Drivers' License Production across States from 2007-2022
                </h5>
            </div>
        </div>
        <div class="p-2">
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($nationalDrivers as $nationalDriver)
            <tr>
                <td>{{ $nationalDriver->id }}</td>
                <td>{{ $nationalDriver->states }}</td>
                <td>{{ $nationalDriver['2008'] }}</td>
                <td>{{ $nationalDriver['2009']}}</td>
                <td>{{ $nationalDriver['2010']}}</td>
                <td>{{ $nationalDriver['2014']}}</td>
                <td>{{ $nationalDriver['2015']}}</td>
                <td>{{ $nationalDriver['2016']}}</td>
                <td>{{ $nationalDriver['2017']}}</td>
                <td>{{ $nationalDriver['2018'] }}</td>
                <td>{{ $nationalDriver['2019']}}</td>
                <td>{{ $nationalDriver['2020']}}</td>
                <td>{{ $nationalDriver['2021']}}</td>
                <td>{{ $nationalDriver['2022'] }}</td>
