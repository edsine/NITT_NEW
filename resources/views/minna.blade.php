...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Minna Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('minna.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('minna.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($minnas as $minna)
            <tr>
                <td>{{ $minna->id }}</td>
                <td>{{ $minna->year }}</td>
                <td>{{ $minna->domestic_passenger_traffic }}</td>
                <td>{{ $minna->international_passenger_traffic }}</td>
                <td>{{ $minna->air_traffic_domestic }}</td>
                <td>{{ $minna->air_traffic_international }}</td>
                <td>{{ $minna->cargo_traffic_domestic }}</td>
                <td>{{ $minna->cargo_traffic_international }}</td>
                <td>{{ $minna->mail_traffic_domestic }}</td>
                <td>{{ $minna->mail_traffic_international }}</td>
