...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Benin Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('benin.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('benin.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($benins as $benin)
            <tr>
                <td>{{ $benin->id }}</td>
                <td>{{ $benin->year }}</td>
                <td>{{ $benin->domestic_passenger_traffic }}</td>
                <td>{{ $benin->international_passenger_traffic }}</td>
                <td>{{ $benin->air_traffic_domestic }}</td>
                <td>{{ $benin->air_traffic_international }}</td>
                <td>{{ $benin->cargo_traffic_domestic }}</td>
                <td>{{ $benin->cargo_traffic_international }}</td>
                <td>{{ $benin->mail_traffic_domestic }}</td>
                <td>{{ $benin->mail_traffic_international }}</td>
