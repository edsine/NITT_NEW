...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Katsina Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('katsina.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('katsina.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($katsinas as $katsina)
            <tr>
                <td>{{ $katsina->id }}</td>
                <td>{{ $katsina->year }}</td>
                <td>{{ $katsina->domestic_passenger_traffic }}</td>
                <td>{{ $katsina->international_passenger_traffic }}</td>
                <td>{{ $katsina->air_traffic_domestic }}</td>
                <td>{{ $katsina->air_traffic_international }}</td>
                <td>{{ $katsina->cargo_traffic_domestic }}</td>
                <td>{{ $katsina->cargo_traffic_international }}</td>
                <td>{{ $katsina->mail_traffic_domestic }}</td>
                <td>{{ $katsina->mail_traffic_international }}</td>
