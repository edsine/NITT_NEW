...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Akanu Ibiam Airport, Abuja Domestics and International Passenger Traffic, Aircraft Traffic, Cargo Traffic and Mail Traffic from 1987 to 2021
                </h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('akanu.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('akanu.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($akanuIbiams as $akanu)
            <tr>
                <td>{{ $akanu->id }}</td>
                <td>{{ $akanu->year }}</td>
                <td>{{ $akanu->domestic_passenger_traffic }}</td>
                <td>{{ $akanu->international_passenger_traffic }}</td>
                <td>{{ $akanu->air_traffic_domestic }}</td>
                <td>{{ $akanu->air_traffic_international }}</td>
                <td>{{ $akanu->cargo_traffic_domestic }}</td>
                <td>{{ $akanu->cargo_traffic_international }}</td>
                <td>{{ $akanu->mail_traffic_domestic }}</td>
                <td>{{ $akanu->mail_traffic_international }}</td>
