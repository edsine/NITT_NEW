...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Comprehensive Year 2008-2010 and 2014-2022 of MotorCycle Plate Number Production Analysis</h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('motorCyclePlate.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('motorCyclePlate.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($motorCyclePlates as $motorCyclePlate)
            <tr>
                <td>{{ $motorCyclePlate->id }}</td>
                <td>{{ $motorCyclePlate->category }}</td>
                <td>{{ $motorCyclePlate['2008'] }}</td>
                <td>{{ $motorCyclePlate['2009']}}</td>
                <td>{{ $motorCyclePlate['2010']}}</td>
                <td>{{ $motorCyclePlate['2014']}}</td>
                <td>{{ $motorCyclePlate['2015']}}</td>
                <td>{{ $motorCyclePlate['2016']}}</td>
                <td>{{ $motorCyclePlate['2017']}}</td>
                <td>{{ $motorCyclePlate['2018'] }}</td>
                <td>{{ $motorCyclePlate['2019']}}</td>
                <td>{{ $motorCyclePlate['2020']}}</td>
                <td>{{ $motorCyclePlate['2021']}}</td>
                <td>{{ $motorCyclePlate['2022'] }}</td>
