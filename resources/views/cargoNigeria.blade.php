...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Cargo Import, Export And throughput of Nigeria Ports From 1996-2021</h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('CargoNigeria.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('CargoNigeria.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($cargoNigerias as $cargoNigeria)
            <tr>
                <td>{{ $cargoNigeria->id }}</td>
                <td>{{ $cargoNigeria->year }}</td>
                <td>{{ $cargoNigeria->import }}</td>
                <td>{{ $cargoNigeria->export}}</td>
                <td>{{ $cargoNigeria->total_throughput}}</td>
