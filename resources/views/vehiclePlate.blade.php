...
@endif
    ...
    <div class="d-flex">
        <div class="mr-auto p-2">
            <div class="d-flex justify-content-start">
                <h5>Comprehensive Year 2008-2010 and 2014-2022 of Vehicle Plate Number Production Analysis</h5>
            </div>
        </div>
        <div class="p-2">
            <div class="d-flex justify-content-end">
                <form id="importForm" action="{{ route('vehiclePlate.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="button" class="btn btn-secondary">
                    <a href="{{ route('vehiclePlate.export') }}" style="color:white; text-decoration:none;">Export</a>
                </button>
            </div>
        </div>
    </div>
    ...
    <table id="passengers-table" class="table table-bordered table-striped">
        ...
        <tbody>
            @foreach($vehiclePlates as $vehiclePlate)
            <tr>
                <td>{{ $vehiclePlate->id }}</td>
                <td>{{ $vehiclePlate->category }}</td>
                <td>{{ $vehiclePlate['2008'] }}</td>
                <td>{{ $vehiclePlate['2009']}}</td>
                <td>{{ $vehiclePlate['2010']}}</td>
                <td>{{ $vehiclePlate['2014']}}</td>
                <td>{{ $vehiclePlate['2015']}}</td>
                <td>{{ $vehiclePlate['2016']}}</td>
                <td>{{ $vehiclePlate['2017']}}</td>
                <td>{{ $vehiclePlate['2018'] }}</td>
                <td>{{ $vehiclePlate['2019']}}</td>
                <td>{{ $vehiclePlate['2020']}}</td>
                <td>{{ $vehiclePlate['2021']}}</td>
                <td>{{ $vehiclePlate['2022'] }}</td>
