...
class ReprintVehicleAndMotocycleController extends Controller
{
    public function index()
    {
        $data = ReprintVehicleAndMotocycle::all();
    ...
    public function store(Request $request)
    {
        ...
        $data = ReprintVehicleAndMotocycle::create($request->all());
    ...
    {
        $data = ReprintVehicleAndMotocycle::find($id);
