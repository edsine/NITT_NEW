...
use App\Models\AkwaIbomTrafficOffencesVio;

class AkwaIbomTrafficOffencesVioController extends Controller
{
    public function index()
    {
        $data = AkwaIbomTrafficOffencesVio::all();
    ...
    public function store(Request $request)
    {
        ...
        $data = AkwaIbomTrafficOffencesVio::create($request->all());
    ...
    {
        $data = AkwaIbomTrafficOffencesVio::find($id);
